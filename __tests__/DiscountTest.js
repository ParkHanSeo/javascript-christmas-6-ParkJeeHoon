...
describe("DecemberEvent 클래스 테스트", () => {
    ...
    test("특별 할인 계산 테스트 - 일요일 할인 적용", () => {
        const discount = new Discount();
        const orderMenu = new Order(('크리스마스파스타-1,초코케이크-1').split(',')).totalMenuOrderAmount();
    ...
    test("특별 할인 계산 테스트 - 크리스마스 할인 적용", () => {
        const discount = new Discount();
        const orderMenu = new Order(('해산물파스타-2,레드와인-1').split(',')).totalMenuOrderAmount();
    ...
    test("특별 할인 계산 테스트 - 할인 미적용", () => {
        const discount = new Discount();
        const orderMenu = new Order(('바비큐립-1,샴페인-1').split(',')).totalMenuOrderAmount();
